...
import { createPresetManager } from "./preset-manager.js?v=202610127";
import { createWorkflowImporter } from "./workflow-import.js?v=202610127";
...
app.registerExtension({
  ...
  setup() {
    ...
    if (!document.getElementById("mobile-remote-styles")) {
      ...
      stylesheet.href = `${new URL("./remote.css", import.meta.url).href}?v=202610127`;
