import { ready as i18nReady, t } from "./i18n.js?v=202609306";

// 词典到位后再注册界面，否则侧边栏标题会先渲染成中文原文。
await i18nReady;
import { app } from "../../scripts/app.js";
import { createPresetManager } from "./preset-manager.js?v=202609306";
import { createWorkflowImporter } from "./workflow-import.js?v=202609306";
...
app.registerExtension({
  ...
  setup() {
    ...
    if (!document.getElementById("mobile-remote-styles")) {
      ...
      stylesheet.href = `${new URL("./remote.css", import.meta.url).href}?v=202609306`;
