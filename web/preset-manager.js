...
import "/mobile/assets/preset-catalog.js?v=202610126";
import { sharedCatalogStore } from "./preset-store.js?v=202610126";

const Model = globalThis.MobilePresetCatalog;
const CATALOG_URL = "/mobile/assets/prompt-presets.json?v=202610126";
